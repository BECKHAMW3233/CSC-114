...
mnist_sgd_64.py
===============
MNIST OCR — OCRConvNetTriple, SGD + Nesterov, 64×64
...
Watch point — non-monotonic resolution behavior:
  ...
  directly tests whether that inversion is a 62-class artifact or an SGD
  fundamental behavior. Per-class accuracy at each resolution will be compared
