...
if all_ok:
    ...
    print()
    print("  Ready for:")
    print("    python ocr_pipeline.py          — inference")
    print("    python ocr_pytorch_model.py     — train Model 1 (Lion)")
    print("    python ocr_pytorch_model2.py    — train Model 2 (Schedule-Free AdamW)")
    print("    python ocr_pytorch_model3.py    — train Model 3 (SGD + CosineAnnealingLR)")
