...
|---|---|---|---|
| 05/30/26 | Module 0 Quiz | Quiz | 100 |
| 06/07/26 | Create a Custom Agent | Assignment | 100 |
| 06/21/26 | Apply AI Frameworks | Assignment | 100 |
| 06/21/26 | Assess AI Frameworks | Assignment | 100 |
| 06/28/26 | Apply Classification & Regression | Assignment | 100 |
| 06/28/26 | Assess Classification & Regression | Assignment | 100 |
| 07/05/26 | Apply Machine Learning Workflow | Assignment | 100 |
| 07/05/26 | Assess Machine Learning Workflow | Assignment | 100 |
| 07/12/26 | Apply Computer Vision | Assignment | 100 |
| 07/12/26 | Assess Computer Vision | Assignment | 100 |
| 07/19/26 | Apply NLP and LLMs | Assignment | 1* |
| 07/19/26 | Assess NLP and LLMs | Assignment | 100 |
| 07/20/26 | Final Project | Assignment | 100 |

*Point value as listed in syllabus — likely a typo; confirm with instructor.
...
**Predecessor repo:** [CSC-113: AI Fundamentals](https://github.com/BECKHAMW3233)
...
```
csc-114-ai-fundamentals/
├── module-0/
├── module-1-custom-agent/
├── module-2-ai-frameworks/
├── module-3-classification-regression/
├── module-4-ml-workflow/
